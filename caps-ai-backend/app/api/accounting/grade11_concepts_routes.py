...
from ...utils.grade11_accounting.concepts_generator import generate_questions


@accounting_bp.route('/grade11/accounting/concepts/generate', methods=['POST'])
def generate_grade11_accounting_concepts():
    try:
