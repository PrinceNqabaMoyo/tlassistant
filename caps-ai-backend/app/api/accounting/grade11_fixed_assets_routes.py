...
from ...utils.grade11_accounting.fixed_assets_generator import generate_questions


@accounting_bp.route('/grade11/accounting/fixed-assets/generate', methods=['POST'])
def generate_grade11_accounting_fixed_assets():
    try:
