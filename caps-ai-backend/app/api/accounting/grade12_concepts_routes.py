...
from ...utils.grade12_accounting.concepts_generator import generate_questions


@accounting_bp.route('/grade12/accounting/concepts/generate', methods=['POST'])
def generate_grade12_accounting_concepts():
    try:
