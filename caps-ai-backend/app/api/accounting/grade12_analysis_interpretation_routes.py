...
from ...utils.grade12_accounting.analysis_interpretation_generator import generate_questions


@accounting_bp.route('/grade12/accounting/analysis-interpretation/generate', methods=['POST'])
def generate_grade12_accounting_analysis_interpretation():
    try:
