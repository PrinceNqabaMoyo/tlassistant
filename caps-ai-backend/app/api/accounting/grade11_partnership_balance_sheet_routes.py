...
from ...utils.grade11_accounting.partnership_balance_sheet_generator import generate_questions


@accounting_bp.route('/grade11/accounting/partnership-balance-sheet/generate', methods=['POST'])
def generate_grade11_accounting_partnership_balance_sheet():
    try:
