...
from ...utils.grade10_accounting.ethics_generator import generate_questions


@accounting_bp.route('/grade10/ethics/generate', methods=['POST'])
def generate_grade10_ethics():
    try:
