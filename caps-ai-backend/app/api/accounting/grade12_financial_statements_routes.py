...
from ...utils.grade12_accounting.financial_statements_notes_generator import generate_questions


@accounting_bp.route('/grade12/accounting/financial-statements-notes/generate', methods=['POST'])
def generate_grade12_accounting_financial_statements_notes():
    try:
