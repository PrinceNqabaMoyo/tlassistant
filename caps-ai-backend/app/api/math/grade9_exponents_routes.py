...
from . import math_bp
from ...utils.grade9_exponents_generator import generate_grade9_exponents_question


@math_bp.route('/grade9/exponents/generate', methods=['POST'])
def generate_grade9_exponents():
    try:
        ...
        for i in range(count):
            ...
            question = generate_grade9_exponents_question(
                subskill=subskill,
