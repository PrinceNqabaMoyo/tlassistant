...
from . import math_bp
from ...utils.grade11_analytical_geometry_generator import generate_questions


@math_bp.route('/grade11/analytical-geometry/generate', methods=['POST'])
def generate_grade11_analytical_geometry():
    try:
