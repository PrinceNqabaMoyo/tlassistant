...
from . import math_bp
from ...utils.grade9_whole_numbers_generator import generate_grade9_whole_numbers_question


@math_bp.route('/grade9/whole-numbers/generate', methods=['POST'])
def generate_grade9_whole_numbers():
    try:
        ...
        for i in range(count):
            ...
            q = generate_grade9_whole_numbers_question(
                subskill=subskill,
