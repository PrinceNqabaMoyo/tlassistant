...
from . import math_bp
from ...utils.grade9_fractions_generator import generate_grade9_fractions_question


@math_bp.route('/grade9/fractions/generate', methods=['POST'])
def generate_grade9_fractions():
    try:
        ...
        for i in range(count):
            ...
            question = generate_grade9_fractions_question(
                subskill=subskill,
