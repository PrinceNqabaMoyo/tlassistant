...
from . import math_bp
from ...utils.grade10_exponents_generator import generate_grade10_exponents_question


@math_bp.route('/grade10/exponents/generate', methods=['POST'])
def generate_grade10_exponents():
    try:
        ...
        for i in range(count):
            ...
            question = generate_grade10_exponents_question(
                subskill=subskill,
