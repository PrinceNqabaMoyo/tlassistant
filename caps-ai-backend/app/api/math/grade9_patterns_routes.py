...
from . import math_bp
from ...utils.grade9_patterns_generator import generate_grade9_patterns_question


@math_bp.route('/grade9/patterns/generate', methods=['POST'])
def generate_grade9_patterns():
    try:
        ...
        for i in range(count):
            ...
            question = generate_grade9_patterns_question(
                subskill=subskill,
