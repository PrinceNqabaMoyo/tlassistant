...
from . import math_bp
from ...utils.grade11_patterns_sequences_generator import generate_questions


@math_bp.route('/grade11/patterns-sequences/generate', methods=['POST'])
def generate_grade11_patterns_sequences():
    try:
        ...
        for i in range(count):
            ...
            # one question per call for stable per-question seed offsets
