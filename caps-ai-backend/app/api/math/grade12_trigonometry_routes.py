...
from . import math_bp
from ...utils.grade12_trigonometry_generator import generate_questions


@math_bp.route('/grade12/trigonometry/generate', methods=['POST'])
def generate_grade12_trigonometry():
    try:
