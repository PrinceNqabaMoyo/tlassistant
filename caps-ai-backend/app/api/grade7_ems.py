...
from app.utils.grade7_ems import (
    ...
    term1_businesses,
    term1_goods_and_services,
    term2_accounting_concepts,
    term2_income_and_expenses,
    term2_budgets,
    term3_entrepreneurship,
    term3_inequality_and_poverty,
)
from app.utils.grade7_ems._ems_curriculum import get_g7_topic_sections, get_g7_section_for_topic
...
GENERATORS = {
    ...
    'grade7_ems_needs_and_wants': term1_money_and_needs.generate,
    'grade7_ems_goods_and_services': term1_goods_and_services.generate,
    ...
    'grade7_ems_the_entrepreneur': term3_entrepreneurship.generate,
    'grade7_ems_starting_a_business': term3_entrepreneurship.generate,
    'grade7_ems_entrepreneurs_day': term3_entrepreneurship.generate,
    'grade7_ems_inequality_and_poverty': term3_inequality_and_poverty.generate,
}
...
def generate_questions(topic, subskill, difficulty, count=1, mode='scaffold', config=None):
    ...
    section = get_g7_topic_sections(topic)
    if section:
        for sec in section:
...
@grade7_ems_bp.route('/sections', methods=['GET'])
def get_grade7_ems_sections():
...
@grade7_ems_bp.route('/mark', methods=['POST'])
def mark_grade7_ems():
    """Unified endpoint for marking Grade 7 EMS questions."""
    data = request.json
    ...
    # Build per-question correctness metadata for streak tracking
    metadata = {
