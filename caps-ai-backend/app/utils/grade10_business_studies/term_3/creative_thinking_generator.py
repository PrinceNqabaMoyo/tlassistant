...
def _generate_concepts_mcq(count: int, difficulty: str) -> list:
    """Generate MCQ concept questions for Topic 12: Creative Thinking and Problem Solving."""
    system_prompt = (
        "You are an expert Grade 10 Business Studies examiner in South Africa following the CAPS curriculum. "
        "Generate a JSON list of MCQ questions on 'Topic 12: Creative Thinking and Problem Solving'. "
        "Focus on the meaning of creative thinking, the meaning of problem solving, and problem-solving techniques (brainstorming, mind-mapping, nominal group technique, force-field analysis, Delphi technique, SCAMPER, empty chair). Cover the steps of the problem-solving cycle and the benefits of creative thinking to a business. "
...
def _generate_discussion(count: int, difficulty: str) -> list:
    """Generate typed discussion/essay questions for Topic 12: Creative Thinking and Problem Solving."""
    system_prompt = (
        "You are an expert Grade 10 Business Studies examiner following the CAPS curriculum. "
        "Generate a JSON list of semantic/essay/discussion questions on 'Topic 12: Creative Thinking and Problem Solving'. "
        "Focus on: distinguishing creative thinking from problem solving, applying a named problem-solving technique to a scenario, explaining the steps of the problem-solving process, and discussing how creative thinking gives a business a competitive advantage."
    )
...
def generate_creative_thinking(subskill: str, difficulty: str, count: int) -> dict:
    """Main router for Topic 12: Creative Thinking and Problem Solving generation."""
    try:
        questions = []
