...
def _application_pool(rng):
    ...
    market_response_case = _build_market_response_context(r)
    return [
        _with_metadata({
        ...
        _with_metadata({
            'title': 'Strategic responses from supplier, competitor and regulator pressures',
            'prompt': f"{market_response_case['business_name']} depends on raw materials from {market_response_case['supplier_name']}. Supplier costs keep changing, stronger competitors are putting pressure on prices, and new rules from regulators are affecting operations. Advise the business on strategic responses it can use to respond to suppliers, competitors and regulators. (6 marks)",
            'marks': 6,
            'marking_points': [
                'The business can sign long-term contracts with suppliers at fixed prices.',
                'The business can buy in bulk or form a strategic alliance with suppliers to secure inputs.',
                'The business can join a business forum, consortium or strategic alliance to respond to competitors.',
                'The business can lobby regulators through representative bodies or collective business action.',
                'The answer should show that businesses have limited influence over market actors and can influence regulators more effectively when they act together.',
                'Strategic responses should be linked to adaptation rather than passive acceptance of pressure.'
            ],
            'sample_answer': f"{market_response_case['business_name']} can respond to supplier pressure by signing long-term contracts at fixed prices, buying in bulk, or forming a strategic alliance with {market_response_case['supplier_name']}. It can respond to competitors by joining {market_response_case['forum_name']} or forming a consortium to share ideas and resources. It can respond to regulators by working through representative bodies to lobby for helpful changes. These strategic responses help the business adapt instead of remaining passive.",
            'difficulties': ['medium', 'hard'],
            'hint_sections': [
                {'title': 'What is being asked?', 'text': 'You must advise the business on practical strategic responses for three different stakeholder pressures.'},
                {'title': 'Scenario evidence', 'text': 'Use supplier actions such as contracts or alliances, competitor actions such as forums or consortia, and regulator actions such as lobbying.'},
                {'title': 'Reasoning path', 'text': 'Match one practical response to each pressure, then explain how the response helps the business adapt.'}
            ],
            'answer_part_hints': [
                'Advise one response to supplier pressure.',
                'Advise one response to competitor pressure.',
                'Advise one response to regulator pressure.'
            ],
            'guidelines': ['Use practical action verbs such as sign, buy, join, form and lobby.'],
            'teaching_note': 'This scenario family anchors strategic-response advice in the curriculum notes on suppliers, competitors and regulators.',
            'keywords': ['long-term contracts', 'fixed prices', 'buy in bulk', 'strategic alliance', 'consortium', 'business forum', 'lobby', 'regulators'],
        }, subskill='application', learning_objective_id='lo_adapt_to_business_environment_challenges', question_family_id='strategic_responses_lobbying_networking_adaptation', concept_id='strategic_responses', concept_group='adaptation_and_response', scenario_family_id='supplier_competitor_regulator_response_case', retry_variant='core', diagnostic_tags=['advice', 'adaptation', 'market_influence'], answer_structure_tags=['advise', 'stakeholder_response', 'adapt'], minimum_mastery_score=0.6),
        _with_metadata({
            'title': 'Strategic responses from stakeholder pressures with cues',
            'prompt': f"Use the case below to advise {market_response_case['business_name']} on strategic responses. Include one supplier response, one competitor response, and one regulator response. (6 marks)\n\n{market_response_case['business_name']} depends on raw materials from {market_response_case['supplier_name']}. Supplier costs keep changing, stronger competitors are putting pressure on prices, and new rules from regulators are affecting operations.",
            'marks': 6,
            'marking_points': [
                'The business can sign long-term contracts with suppliers at fixed prices.',
                'The business can buy in bulk or form a strategic alliance with suppliers to secure inputs.',
            ...
            'sample_answer': f"{market_response_case['business_name']} can respond to suppliers by signing long-term contracts or buying in bulk. It can respond to competitors by joining {market_response_case['forum_name']} or forming a consortium. It can respond to regulators by lobbying through representative bodies. These responses help the business adapt to pressure more effectively.",
            'difficulties': ['medium', 'hard'],
            'hint_sections': [
                {'title': 'What is being asked?', 'text': 'This guided version gives you three response lanes: suppliers, competitors and regulators.'},
                {'title': 'Scenario evidence', 'text': 'Think contracts or alliances for suppliers, business forums or consortia for competitors, and lobbying for regulators.'},
                {'title': 'Reasoning path', 'text': 'Write one practical response in each lane and then link it to adaptation.'}
            ],
            'answer_part_hints': [
                'Write one supplier response.',
                'Write one competitor response.',
                'Write one regulator response.'
            ],
            'guidelines': ['Group the answer into the three stakeholder categories given in the prompt.'],
            'teaching_note': 'This guided retry structures the same curriculum-backed strategic-response line into three clear stakeholder categories.',
            'keywords': ['long-term contracts', 'buy in bulk', 'strategic alliance', 'business forum', 'consortium', 'lobby', 'regulators'],
        }, subskill='application', learning_objective_id='lo_adapt_to_business_environment_challenges', question_family_id='strategic_responses_lobbying_networking_adaptation', concept_id='strategic_responses', concept_group='adaptation_and_response', scenario_family_id='supplier_competitor_regulator_response_case', retry_variant='guided', diagnostic_tags=['advice', 'adaptation', 'market_influence'], answer_structure_tags=['guided_advice', 'stakeholder_response', 'adapt'], minimum_mastery_score=0.6),
        _with_metadata({
            'title': 'Strategic responses from stakeholder pressures reworded',
            'prompt': f"A business is struggling with changing supplier prices, stronger competitors and regulations that affect operations. Explain how {market_response_case['business_name']} can use strategic responses such as long-term contracts, alliances, business forums and lobbying to adapt. (6 marks)",
            'marks': 6,
            'marking_points': [
                'The business can sign long-term contracts with suppliers at fixed prices.',
                'The business can buy in bulk or form a strategic alliance with suppliers to secure inputs.',
            ...
            'sample_answer': f"{market_response_case['business_name']} can adapt by using long-term contracts or bulk buying to manage supplier pressure, joining {market_response_case['forum_name']} or forming alliances to respond to competitors, and lobbying regulators through representative bodies. These responses help the business manage pressure more actively and strategically.",
            'difficulties': ['medium', 'hard'],
            'hint_sections': [
                {'title': 'What is being asked?', 'text': 'This reworded version gives you the same strategy line in a shorter pressure-and-response frame.'},
                {'title': 'Scenario evidence', 'text': 'Link supplier pressure to contracts or bulk buying, competitor pressure to alliances or forums, and regulator pressure to lobbying.'},
                {'title': 'Reasoning path', 'text': 'Show how each strategic response changes the business position instead of only naming the strategy.'}
            ],
            'answer_part_hints': [
                'Explain one supplier strategy.',
                'Explain one competitor strategy.',
                'Explain one regulator strategy.'
            ],
            'guidelines': ['Use cause-and-effect wording such as this helps the business to ...'],
            'teaching_note': 'This reworded retry keeps the same curriculum-backed memo line while simplifying the scenario surface.',
            'keywords': ['long-term contracts', 'bulk buying', 'strategic alliance', 'business forum', 'consortium', 'lobby', 'adapt'],
        }, subskill='application', learning_objective_id='lo_adapt_to_business_environment_challenges', question_family_id='strategic_responses_lobbying_networking_adaptation', concept_id='strategic_responses', concept_group='adaptation_and_response', scenario_family_id='supplier_competitor_regulator_response_case', retry_variant='reworded', diagnostic_tags=['advice', 'adaptation', 'market_influence'], answer_structure_tags=['reworded_advice', 'stakeholder_response', 'adapt'], minimum_mastery_score=0.6),
        _with_metadata({
            'title': 'Strategic responses from stakeholder pressures transfer',
            'prompt': f"Use the prompts below to show how {market_response_case['business_name']} can adapt to stakeholder pressures. (6 marks)\n\n- One action to respond to suppliers\n- One action to respond to competitors\n- One action to influence regulators",
            'marks': 6,
            'marking_points': [
                'The business can sign long-term contracts with suppliers at fixed prices.',
                'The business can buy in bulk or form a strategic alliance with suppliers to secure inputs.',
            ...
            'sample_answer': f"{market_response_case['business_name']} can respond to suppliers by signing long-term contracts or buying in bulk, respond to competitors by joining {market_response_case['forum_name']} or forming a consortium, and influence regulators by lobbying through representative bodies.",
            'difficulties': ['easy', 'medium', 'hard'],
            'hint_sections': [
                {'title': 'What is being asked?', 'text': 'This transfer version breaks the strategic-response task into three simple prompts.'},
                {'title': 'Scenario evidence', 'text': 'Choose one clear action for suppliers, one for competitors and one for regulators.'},
                {'title': 'Reasoning path', 'text': 'Keep the response practical and organised by stakeholder.'}
            ],
            'answer_part_hints': [
                'Write one supplier action.',
                'Write one competitor action.',
                'Write one regulator action.'
            ],
            'guidelines': ['Answer each prompt with one concrete action rather than a vague statement.'],
            'teaching_note': 'This reduced-complexity transfer retry supports retrieval of stakeholder-specific strategic responses from the curriculum notes.',
            'keywords': ['long-term contracts', 'buy in bulk', 'strategic alliance', 'business forum', 'consortium', 'lobby', 'regulators'],
        }, subskill='application', learning_objective_id='lo_adapt_to_business_environment_challenges', question_family_id='strategic_responses_lobbying_networking_adaptation', concept_id='strategic_responses', concept_group='adaptation_and_response', scenario_family_id='supplier_competitor_regulator_response_case', retry_variant='transfer', diagnostic_tags=['advice', 'adaptation', 'market_influence'], answer_structure_tags=['transfer_advice', 'stakeholder_response', 'adapt'], minimum_mastery_score=0.6),
        _with_metadata({
...
def _build_market_response_context(rng):
    return {
        'business_name': _pick_business_name(r=rng, suffixes=MANUFACTURING_SUFFIXES),
        'supplier_name': _pick_supplier_name(r=rng),
        'forum_name': rng.choice(['a community business forum', 'a local business forum', 'a regional business network']),
    }
