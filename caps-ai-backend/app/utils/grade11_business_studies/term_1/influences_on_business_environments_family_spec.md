...
| `strategic_responses_lobbying_networking_adaptation` | `strategic_responses` | `adaptation_and_response` | `supplier_competitor_regulator_response_case` | `core`, `guided`, `reworded`, `transfer` | Curriculum-backed stakeholder-response line using supplier, competitor, and regulator pressures |
...
| `supplier_competitor_regulator_response_case` | `strategic_responses_lobbying_networking_adaptation` | Strategic responses using supplier contracts or alliances, competitor forums or consortia, and regulator lobbying |
...
- a curriculum-backed stakeholder-response scenario line covering suppliers, competitors, and regulators

## Next extension points

- add additional curriculum-backed scenario lines beyond the current Bavi, Joe's, Majeed, BrightPath, retailer, Vincent, and supplier-competitor-regulator cases
