...
1. Which of the following are not rational numbers?

a. π = 3,141 592 653 589 793 238 462 643 383 279 502 884 197 169 399 375 10 . . .
...
f. 0,02 \[bar over the 2 decimal places]
...
2\. Problem: Write 0,3˙\[dot over 3] in the form a/b (where a and b are integers).
...
3\. Problem: Write 5,4˙3˙2˙ as a rational fraction \[dot over each of 4, 3 and 2]
...
1. Problem: Round off the following numbers to the indicated number of decimal places:

a. 120/99 = 1,1˙2˙ \[dots over the 1 and 2 after decimal point] to 3 decimal places.

b. π = 3,141592653 . . . to 4 decimal places.

c. √3 = 1,7320508 . . . to 4 decimal places.

d. 2,78974526 to 3 decimal places.
...
a. 120/99 = 1,212 rounded to 3 decimal places.

b. π = 3,1416 rounded to 4 decimal places.
...
1. Problem: Find the two consecutive integers such that √26 lies between them. (Remember that consecutive integers are two integers that follow one another on the number line, for example, 5 and 6 or 8 and 9).
...
2\. Problem: Find the two consecutive integers such that √3 49 lies between them.
...
Step 4 : Check the answer by cubing all terms in the inequality and then simplify 27 < 49 < 64. This is true, so ∛49 lies between 3 and 4.
...
1. Problem: Simplify: 2a(a − 1) − 3(a^2 − 1).
...
2\. Problem: Find the product: (3x − 2)(5x + 8).
...
3\. Problem: Find the product: (x − 1)(x^2 − 2x + 1).
...
24\. (−6y^4 + 11y^2 + 3y)(y + 4)(y − 4)





### Factorisation uding common factors and recognising a difference of 2 squares
...
1. Problem: Factorise: 5(a − 2) − b(2 − a).
...
2\. Problem: Factorise: 3a(a^2 − 4) − 7(a^2 − 4).
...
1. Problem: Find the factors of 7x + 14y + bx + 2b
...
7 is a common factor of the first two terms and b is a common factor

of the second two terms. We see that the ratio of the coefficients

7 : 14 is the same as b : 2b.
...
Note: If c is positive, then the factors of c must be either both positive or both negative. If c is negative, it means only one of the factors of c is negative, the other one being positive. Once you get an answer, always multiply out your brackets again just to make sure it really works.
...
Step 1 : Check that the quadratic is in required form ax^2 + bx + c
...
4\. Problem: Factorise: 8t^3 + 125p^3.
...
1. Problem: Simplify: (ax − b + x − ab)/(ax^2 − abx), (x ≠ 0; x ≠ b).
...
2\. Problem: Simplify: (x^2 − x − 2)/(x^2 − 4) ÷ (x^2+x)/x(x+2), (x ≠ 0; ≠ ±2).
...
10\. (3a + 9)/14 ÷ (7a + 21)/(a + 3)

11\. (a^2 − 5a)/(2a +10) × 4a/(3a +15)

12\. (3xp + 4p)/8p ÷ 12p^2/(3x+4)

13\. (24a -8)/12 ÷ (9a -3)/6

14\. (a^2 + 2a)/5 ÷ (2a +4)/20

15\. (p^2 + pq)/7p × 21q/(8p + 8q)

16\. (5ab − 15b)/(4a-12) ÷ 6b^2/(a+b)
...
23\. x/(x+y) + x^2/(y^2 - x^2)

24\. 1/(m+n) + 3mn/(m^3 + n^3)

25\. h/(h^3 - f^3) - 1/(h^2 + hf + f^2)

26\. (x^2 -1)/3 × 1/(x-1) -1/2

27\. (x^2 − 2x + 1)/(x-1)^3 - (x^2 + x + 1)/(x^3 -1)

28\. 1/(x-1)^2 - 2x/(x^3 - 1)

29\. (p^3 + q^3)/p^2 × (3p - 3q)/(p^2 - q^2)

30\. 1/(a^2 - 4ab +4b^2) + (a^2 + 2ab + b^2)/(a^3 -8b^3) - 1/(a^2 - 4b^2)
...
3\. Show that the decimal 3,211˙8˙ \[dots over the 2nd 1 and 8] is a rational number.



4\. Express 0,78˙\[dot over 8] as a fraction a/b where a,b ∈ ℤ (show all working).



5\. Write the following rational numbers to 2 decimal places.
...
(c) 0,111111 ̅ \[bar over the last 1]

(d) 0,999991 ̅ \[bar over 1]



6\. Round off the following irrational numbers to 3 decimal places.
...
8\. Use your calculator (where necessary) and write the following numbers to 5 decimal places. State whether the numbers are irrational or rational.
...
9\. Write the following irrational numbers to 3 decimal places and then write each one as a rational number to get an approximation to the irrational number.
...
10\. Determine between which two consecutive integers the following irrational numbers lie, without using a calculator.
...
(b) (5a − 4b)(25a^2 + 20ab + 16b^2)

(c) (2m − 3)(4m^2 + 9)(2m + 3)

(d) (a + 2b − c)(a + 2b + c)

(e) (p^2 − q^2)/p ÷ (p + q)/(p^2 − pq)
...
(i) (1 − 2a)/(4a^2 − 1) - (a-1)/(2a^2 -3a +1) - 1/(1-a)

(j) (x^2 + 2x)/(x^2 + x + 6) × (x^2 + 2x + 1)/(x^2 + 3x + 2)
...
16\. What must be added to x^2 − x + 4 to make it equal to (x + 2)^2

?



17\. Evaluate (x^3 +1)/(x^2 - x + 1) if x = 7,85 without using a calculator. Show your work.



18\. With what expression must (a − 2b) be multiplied to get a product of a^3 − 8b^3?



19\. With what expression must 27x^3 + 1 be divided to get a quotient of 3x + 1?
