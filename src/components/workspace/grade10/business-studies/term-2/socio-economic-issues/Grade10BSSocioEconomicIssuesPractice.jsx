...
export const Grade10BSSocioEconomicIssuesPractice = ({
    practiceQuestions,
    practiceAnswers,
    setPracticeAnswers,
    practiceFeedback,
            ...
            <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
                <Card className="border-none shadow-xl shadow-slate-200/50 bg-white/80 backdrop-blur-sm overflow-hidden">
                    <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-12 text-center text-white">
                        ...
                        <p className="text-indigo-100 text-lg">Here's how you did on Socio-Economic Issues.</p>
                    </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-slate-500">Topic: Socio-Economic Issues</p>
                </div>
