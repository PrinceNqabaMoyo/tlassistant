                ...
                {visualAidsTab === 'rules' && (
                    <div className="space-y-3">
                        <div className="bg-white border border-gray-200 rounded-lg p-4">
                            ...
                            <div className="text-sm text-gray-700 mt-1">Add/subtract the same number each time (constant difference).</div>
                        </div>
                        <div className="bg-white border border-gray-200 rounded-lg p-4">
                            <div className="text-sm font-semibold text-gray-800">Geometric sequence</div>
                            <div className="text-sm text-gray-700 mt-1">Multiply/divide by the same number each time (constant ratio).</div>
                        </div>
                        <div className="bg-white border border-gray-200 rounded-lg p-4">
                            <div className="text-sm font-semibold text-gray-800">Square / triangular / cube patterns</div>
                            <div className="text-sm text-gray-700 mt-1">Square: n². Triangular: n(n+1)/2. Cube: n³.</div>
                        </div>
                    </div>
                )}
