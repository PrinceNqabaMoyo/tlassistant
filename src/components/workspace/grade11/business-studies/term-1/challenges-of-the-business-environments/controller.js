...
const topicKey = 'grade11_bs_challenges_of_the_business_environments';
...
export const useGrade11BSChallengesController = ({ buildApiUrl }) => {
    ...
    const fetchScaffoldQuestion = async ({ subskill, difficulty, config, avoidQuestionFamilyIds, avoidEvidenceKeys } = {}) => {
        ...
        try {
            ...
            console.error('Failed to fetch Grade 11 Business Studies challenges scaffold question:', err);
    ...
    const fetchPractice = async ({ difficulty, subskill, config }) => {
        ...
        try {
            ...
            console.error('Failed to fetch Grade 11 Business Studies challenges practice questions:', err);
