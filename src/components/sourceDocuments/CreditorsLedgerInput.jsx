...
const CreditorsLedgerInput = ({ initialData, onChange, isSubmitted }) => {
    ...
    const calculateBalance = (currentRowIndex) => {
        ...
        for (let i = 0; i <= currentRowIndex; i++) {
            ...
            balance += credit - debit; // Note: For creditors, credit increases balance
        }
    ...
    const calculateTotals = () => {
        ...
        const finalBalance = totalCredit - totalDebit; // Note: For creditors, credit increases balance
    ...
    return (
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            <div className="mb-6">
                <h3 className="text-xl font-bold text-gray-800 mb-4">Creditors Ledger</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => handleHeaderChange('creditorName', e.target.value)}
                            disabled={isSubmitted}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                ...
                <div className="text-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">
                        Creditors Ledger of {data.businessName || '______'}
                    </h2>
                    <p className="text-lg text-gray-600 mt-2">
                        {data.creditorName || '______'} - Account No: {data.accountNumber || '______'}
                    </p>
                </div>
                ...
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
                    <p className="text-sm text-blue-800">
                        ...
                        {finalBalance > 0 ? ' (Credit Balance - Amount owed to creditor)' : 
                         finalBalance < 0 ? ' (Debit Balance - Amount owed by creditor)' : ' (Balanced)'}
                    </p>
                </div>
...
export default CreditorsLedgerInput;
