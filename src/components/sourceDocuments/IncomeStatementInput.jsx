...
const IncomeStatementInput = ({ initialData, onChange, isSubmitted }) => {
    const [incomeStatementData, setIncomeStatementData] = useState(initialData || {
        ownerName: '',
        businessName: '',
        yearEnded: '',
        incomeFromServices: { main: '', cents: '' },
    ...
    const calculateGrossOperatingIncome = () => {
        const servicesIncome = parseFloat(incomeStatementData.incomeFromServices?.main || 0) + 
                             parseFloat(incomeStatementData.incomeFromServices?.cents || 0) / 100;
        const otherIncome = calculateTotalOtherIncome();
        return servicesIncome + otherIncome;
    };
    ...
    return (
        <div className="p-4 my-4 bg-gray-50 border border-gray-300 rounded-lg">
            <div className="text-center mb-4">
                <h3 className="text-lg font-bold text-gray-800">Income Statement</h3>
            </div>
                ...
                <div className="mb-6">
                    <table className="min-w-full border border-gray-300">
                        ...
                        <tbody>
                            {/* Income Section */}
                            <tr>
                                <td className="border border-gray-300 px-3 py-2 text-sm text-gray-700">Income from services rendered</td>
                                <td className="border border-gray-300 px-3 py-2"></td>
                                <td className="border border-gray-300 px-3 py-2">
                                    <MoneyInput
                                        value={incomeStatementData.incomeFromServices}
                                        onChange={(value) => handleMoneyChange("incomeFromServices", value)}
                                        disabled={isSubmitted}
                                        placeholder="0.00"
                                    />
                                </td>
...
export default IncomeStatementInput;
